...
<html>
    ...
    if(!$select_db)
    {
        ...
        echo '<td align=center width=25%>店名/景點名';
        ...
        while($row=mysql_fetch_array($result)){
            ...
            echo '<td>'.$row[4];
            echo '<td>'.$row[5];
            echo '<td><button><a href=editstore.php?id='.$row[0].'>編輯</button>';
            echo '<td><button><a href=delstore.php?id='.$row[0].'>刪除</button>';
            echo '</tr>';
